...
void showAppCalendarBottomSheetNew(
  ...
  showAppBottomSheet(
    ...
    child: BuildTableCalendar(
      ...
      startYear: 2020, // Укажите начальный год
      endYear: 2025,
      ...
      children: [
        Padding(
          ...
          child:
              ...
              TableCalendar(
                focusedDay: DateTime(widget.startYear, DateTime.now().month, DateTime.now().day),
                firstDay: DateTime(widget.startYear - 1),
                lastDay: DateTime(widget.endYear),
