                    ...
                    Row(
                      children: <Widget>[
                        for (int i = 0; i < 7; i++)
                          InkWell(
                            onTap: () {
                              final selectedDateTime = selectedDate.add(Duration(days: -currentDate + i + 1));
                              calendarController.displayDate = selectedDateTime;
                              calendarController.selectedDate = selectedDateTime;
                              setState(() {
                              });
                            },
                            child: SizedBox(
