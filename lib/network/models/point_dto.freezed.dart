...
mixin _$PointDTO {
  ...
  String? get pharmacyNumber => throw _privateConstructorUsedError;
...
class _$PointDTOCopyWithImpl<$Res, $Val extends PointDTO>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      pharmacyNumber: freezed == pharmacyNumber
          ? _value.pharmacyNumber
          : pharmacyNumber // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$_PointDTO implements _PointDTO {
  const _$_PointDTO(
      ...
      this.from,
      this.to,
      @StringOrNumConverter() this.lat,
      @StringOrNumConverter() this.long,
      this.type,
      this.avatar,
  ...
  @override
  final String? pharmacyNumber;

  @override
  String toString() {
    return 'PointDTO(id: $id, name: $name, address: $address, crossdockingId: $crossdockingId, crossdockName: $crossdockName, crossdockLat: $crossdockLat, crossdockLong: $crossdockLong, status: $status, date: $date, from: $from, to: $to, lat: $lat, long: $long, type: $type, avatar: $avatar, countProducts: $countProducts, pointType: $pointType, isDeviation: $isDeviation, ourPharmacy: $ourPharmacy, eta: $eta, createdAt: $createdAt, products: $products, containers: $containers, pharmacyNumber: $pharmacyNumber)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pharmacyNumber, pharmacyNumber) ||
                other.pharmacyNumber == pharmacyNumber));
  }
...
abstract class _PointDTO implements PointDTO {
  const factory _PointDTO(
      ...
      final String? from,
      final String? to,
      @StringOrNumConverter() final String? lat,
      @StringOrNumConverter() final String? long,
      final dynamic type,
      final dynamic avatar,
      ...
      final List<ProductDTO>? products,
      final List<ContainerDTO>? containers,
      final String? pharmacyNumber}) = _$_PointDTO;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.status, status) || other.status == status) &&
            (identical(other.isSentAndStored, isSentAndStored) ||
                other.isSentAndStored == isSentAndStored));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, containerId, pointId, code,
      createdAt, updatedAt, isScanned, status, isSentAndStored);
...
abstract class _ContainerDTO implements ContainerDTO {
  const factory _ContainerDTO(
      {@JsonKey(name: "id") final int? containerId,
      ...
      final bool isScanned,
      final int? status,
      final bool isSentAndStored}) = _$_ContainerDTO;
